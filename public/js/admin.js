...
const PREDEFINED_COMPONENTS = [
    { category: "Controller", name: "ESP32 Controller", totalQuantity: 20, price: 150, maxPerTeam: 1 },
    ...
    { category: "Sensor", name: "LDR Sensor", totalQuantity: 20, price: 15, maxPerTeam: 1 },
    ...
    { category: "Actuator", name: "Servo Motor", totalQuantity: 20, price: 40, maxPerTeam: 1 },
    { category: "Actuator", name: "Stepper Motor", totalQuantity: 20, price: 80, maxPerTeam: 1 },
    { category: "Actuator", name: "ULN 2003 Driver", totalQuantity: 20, price: 30, maxPerTeam: 1 },
    { category: "Actuator", name: "DC Motor", totalQuantity: 40, price: 30, maxPerTeam: 2 },
    { category: "Actuator", name: "L298N Motor Driver", totalQuantity: 10, price: 60, maxPerTeam: 1 },
    { category: "Actuator", name: "Relay Module", totalQuantity: 20, price: 40, maxPerTeam: 1 },
    { category: "Actuator", name: "Buzzer", totalQuantity: 20, price: 15, maxPerTeam: 1 },
    { category: "Indicator", name: "LED Pack (Assorted)", totalQuantity: 100, price: 5, maxPerTeam: 2 },
    ...
    { category: "Hardware", name: "Breadboard (800 pts)", totalQuantity: 20, price: 40, maxPerTeam: 1 },
    { category: "Hardware", name: "Jumper Wires (set)", totalQuantity: 20, price: 30, maxPerTeam: 1 },
    { category: "Hardware", name: "Resistor Pack", totalQuantity: 20, price: 10, maxPerTeam: 1 },
    { category: "Power", name: "USB Cable", totalQuantity: 20, price: 25, maxPerTeam: 1 },
    ...
    { category: "Power", name: "Power Jack", totalQuantity: 20, price: 15, maxPerTeam: 1 },
    { category: "Power", name: "Single Strand Wire (1m)", totalQuantity: 10, price: 5, maxPerTeam: 1 },
    { category: "Miscellaneous", name: "Foam Board (5mm 1ft X 1ft)", totalQuantity: 40, price: 20, maxPerTeam: 2 },
    { category: "Miscellaneous", name: "Wire Stripper", totalQuantity: 10, price: 50, maxPerTeam: 2 }
];
